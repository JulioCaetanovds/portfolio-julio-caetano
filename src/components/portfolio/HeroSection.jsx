    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 text-center px-6 max-w-3xl mx-auto">
                ...
                >
                    Estudante de Análise e Desenvolvimento de Sistemas. Desenvolvedor focado em criar soluções robustas (Flutter/Dart) e em assegurar a qualidade de cada entrega através da <span className="font-semibold text-foreground">Engenharia de Testes</span> e automação inteligente.
                </motion.p>
