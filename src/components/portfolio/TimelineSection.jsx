...
const experiences = [
    {
        ...
        description:
            "Desenvolvimento e manutenção de 9 aplicativos em Flutter publicados com arquitetura offline-first. Foco em prevenção de falhas e integração robusta com hardware via Bluetooth/IoT.",
    },
    {
